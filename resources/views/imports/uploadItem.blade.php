...
<div class="container pt-5">
  <div class="row">
    <div class="col-lg-12 settgs_right_content">
      ...
      @else
      {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'url' => 'storeImportItemExcel',
      ...
      <div class="card mb-4 no_border">
        ...
        <div class="card-body padding_left_right">
          <h6 class="card_body_header">Upload Item File from Excel
            <a href="{{route('items.index')}}" class="pull-right btn btn-success btn-sm dtb_custom_btn_default">Go to item List</a>
          </h6>
          <hr class="border-light m-0">
          <div class="pb-2 pt-3">
            <div class="form-group">
              <label class="form-label">File Upload</label>
              <input type="file" class="form-control {{ $errors->has('ud_id') ? ' is-invalid' : '' }}" name="file" required="required">
              @if ($errors->has('file'))
