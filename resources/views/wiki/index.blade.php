...
<div class="media-body ml-3">
  ...
  <div>
   ...
   <!--  <a class="download_file" href="{{$attachment->file_path}}" download="{{$attachment->file_name}}">Download</a>  -->

   <a href="{{$attachment->file_path}}"  target="_blank">Download</a> 
    ...
    $(document).ready(function(){
      $('.download_file').click(function(e) {
       ...
       e.preventDefault();  //stop the browser from following
        window.location.href = '{{$attachment->file_path}}';
       });
