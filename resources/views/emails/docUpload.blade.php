...
<body style="background: #e1e1e1;font-family:Arial, Helvetica, sans-serif; font-size:1em; margin-top:100px">
    <style type="text/css">
        div.preheader {
                                                                                ...
                                                                                <tr>
                                                                                    <td class="featured-story__heading featured-story--top__heading"
                                                                                        ...
                                                                                        <table cellspacing="0"
                                                                                            cellpadding="0">
                                                                                            <tr>
                                                                                                <td style="font-family: Geneva, Tahoma, Verdana, sans-serif; font-size: 22px; color: #464646;"
                                                                                                    width="400"
                                                                                                    align="left">
                                                                                                    <a href="#"
                                                                                                        style="text-decoration: none; color: #464646;">{{$title}}</a>
                                                                                                </td>
                                                                                            </tr>
                                                                                        </table>
                                                                                    </td>
                                                                                            ...
                                                                                            <tr>
                                                                                                <td style="font-family: Geneva, Tahoma, Verdana, sans-serif; font-size: 16px; line-height: 22px; color: #555555; padding-top: 16px;"
                                                                                                    align="left">
                                                                                                     ...
                                                                                                     <strong>Global Admission Team</strong>
