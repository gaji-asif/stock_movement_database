 ...
 <div class="card-datatable">
  ...
  <div class="row issue_list_wrapper">
    <div class="table-responsive">
      ...
      <table class="datatables-demo table table-striped table-bordered dtb_custom_tbl_common" style="overflow: hidden !important;">
        <thead>
         <tr>
          ...
          Category</th>
          <th style="width: 100px">
            <i class="fa fa-arrow-down arrow_sorting" arrow_value="version_d"></i> 
            <i class="fa fa-arrow-up arrow_sorting" arrow_value="version_u"></i>
          Version</th>
          <th style="width: 100px">
      ...
      <tbody style="overflow: hidden !important;" class="all_issues_tbody">
          @include('issue.all_issues_projects')
...
<div class="changeatonce row"> 
  ...
  <div class="col-lg-12 middle_thing">
...
//       document.getElementById(frmId).reset();
  ...
  $('body').on('click','.arrow_sorting',function(e){
    ...
    $.ajax({
      url: url+'/issue_search_by_sort_project_wise',
      type: 'POST',
      data: $('#form_search').serialize()+'&arrow_value='+arrow_value,
      success: function(response){
        //alert(response);
         $('.all_issues_tbody').html('');
         if(response){
          $('.all_issues_tbody').html(response);
        }
   ...
   $(document).ready(function(){
   // Initialize
   $('.dtb_custom_tbl_common').DataTable({
      "bSort": false
  });
