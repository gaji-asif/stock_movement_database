...
<!-- Project progress -->
{!! Form::open(['route' => ['update_change_at_once'], 'method' => 'POST','files' => true, 'enctype' => 'multipart/form-data', 'class' => 'form-horizontal', 'id' => 'edit_issue_and_comment'])!!}
...
<div class="card pb-4 mb-2">
   ...
   <!--    <div class="col-12 col-md-5 px-4 pt-4">
      ...
      <div class=" col-md-6 col-sm-12 col-12 text-muted small px-4 pt-4">
         <a href="javascript:void(0)" class="text-body font-weight-semibold">Issue Type</a><br>
...
<div class="row no-gutters align-items-center">
    ...
    <div class=" col-md-6 col-12 text-muted small px-4 pt-2 mb-2">
...
<div class="row no-gutters align-items-center">
  ...
  <div class="col-12 col-md-6 text-muted small px-4 pt-2 mb-2">
     <a href="javascript:void(0)" class="text-body font-weight-semibold">Assign TO</a>
...
<div class="row no-gutters align-items-center">
  ...
  <div class="col-12 col-md-6 text-muted small px-4 pt-2 mb-2 start_date_wrapper">
    <a href="javascript:void(0)" class="text-body font-weight-semibold">Start Date</a>
...
<div class="row no-gutters align-items-center">
  ...
  <div class="col-12 col-md-6 text-muted small px-4 pt-2 mb-2">
    <a href="javascript:void(0)" class="text-body font-weight-semibold">Estimate 1</a>
@if(Session::has('role'))
...
<div class="col-12 col-md-6 text-muted small px-4 pt-2 mb-2">
    <a href="javascript:void(0)" class="text-body font-weight-semibold">Actual time</a>
...
<!-- <div class="col-lg-12">
  <label class="form-label custom-control custom-checkbox mt-3 ml-0">
          <input type="checkbox" name="is_complete" value="1" class="custom-control-input dtb_custom_checkbox_input">
