	...
	<div class="row">
		<div class="col-lg-12 settgs_right_content">
			<div class="card mb-4 no_border">
				...
				<div class="card-body">
					 <h6 class="card_body_header">All Departments List ({{count($data)}}) 
					 	<a href="{{route('department.create')}}"><button class="pull-right btn btn-success btn-sm dtb_custom_btn_default">Add New Department</button></a>
					 </h6>
