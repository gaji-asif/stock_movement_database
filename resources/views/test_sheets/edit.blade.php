...
<div class="row mt-2">
 ...
 <!--
    ...
    {!! Form::open(['route' => ['project.testSheets.update', $id, $editData->id],'id' => 'appeditform',])!!}
         {{ method_field('PUT') }}
  ...
  <div class="form-group row">
     ...
     <div class="col-md-4 ml-sm-auto text-left">
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header" style="background-color: #f8d7da;">
          ...
          <h6 class="modal-title">Are you sure to delete this?</h6>
        </div>
...
///////////APP DELETE OPERATION ////////////////////
  $('body').on('click','.appdelbtn',function(e){
    ...
    var testSheetId = $(this).attr('data');
             ...
             $.ajax({
                ...
                mode: "dark",});
                  setTimeout(function(){// wait for 5 secs(2)
                    document.location.href="{!! route('testSheets.index', $id); !!}";
