...
<!--     <h4 class="font-weight-bold py-3 mb-4">
  ...
  {!! Form::open(['route' => ['testcasecopystore', $id, $editData->id], 'method' => 'POST','files' => true, 'enctype' => 'multipart/form-data','id' => 'appeditform','class' => 'form-horizontal'])!!}
        ...
        <input type="hidden" name="testCaseID" value="<?php echo $editData->id; ?>">

        <input type="hidden" name="test_sheet_id" value="<?php echo $editData->test_sheet_id; ?>">
  ...
  <!--   <h6 style="font-weight: bold;">Staging</h6> -->
      ...
      <div class="col-md-4">
          <div class="form-group">
            ...
            <div class="">
              <input type="text" data-date="" data-date-format="YYY MMMM DD" name="tested_date" id="tested_date" class="controls input-append date form_datetime form-control {{ $errors->has('tested_date') ? ' is-invalid' : '' }}" placeholder="start date" value="{{ old('tested_date',date( 'Y/m/d',strtotime(now()))) }}">
