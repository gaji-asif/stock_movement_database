...
class DtbScreenManageController extends Controller
{
    ...
    public function show($id,$screengroupid,Request $request)
    {
...
public function editorfiles(Request $request){
    ...
    public function screensingle($id,$screengroupid,$screenid,Request $request){
    ...
    public function screenranked($id,$screengroupid,$rank,Request $request){
    ...
    public function screencreate($id,$screengroupid,Request $request){
    ...
    public function screensingleedit($id,$screengroupid,$screenid,Request $request){
